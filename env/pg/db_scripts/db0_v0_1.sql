...
ALTER SEQUENCE human_resources.jobcandidate_jobcandidateid_seq OWNED BY human_resources.job_candidate.jobcandidateid;
...
ALTER SEQUENCE person.addresstype_addresstypeid_seq OWNED BY person.address_type.addresstypeid;
...
ALTER SEQUENCE person.businessentity_businessentityid_seq OWNED BY person.business_entity.businessentityid;
...
ALTER SEQUENCE person.contacttype_contacttypeid_seq OWNED BY person.contact_type.contacttypeid;
...
ALTER SEQUENCE person.emailaddress_emailaddressid_seq OWNED BY person.email_address.emailaddressid;
...
ALTER SEQUENCE person.phonenumbertype_phonenumbertypeid_seq OWNED BY person.phone_number_type.phonenumbertypeid;
...
ALTER SEQUENCE person.stateprovince_stateprovinceid_seq OWNED BY person.state_province.stateprovinceid;
...
ALTER SEQUENCE production.billofmaterials_billofmaterialsid_seq OWNED BY production.bill_of_materials.billofmaterialsid;
...
--
-- Name: job_candidate jobcandidateid; Type: DEFAULT; Schema: human_resources; Owner: postgres
--

ALTER TABLE ONLY human_resources.job_candidate ALTER COLUMN jobcandidateid SET DEFAULT nextval('human_resources.jobcandidate_jobcandidateid_seq'::regclass);
...
--
-- Name: address_type addresstypeid; Type: DEFAULT; Schema: person; Owner: postgres
--

ALTER TABLE ONLY person.address_type ALTER COLUMN addresstypeid SET DEFAULT nextval('person.addresstype_addresstypeid_seq'::regclass);


--
-- Name: business_entity businessentityid; Type: DEFAULT; Schema: person; Owner: postgres
--

ALTER TABLE ONLY person.business_entity ALTER COLUMN businessentityid SET DEFAULT nextval('person.businessentity_businessentityid_seq'::regclass);


--
-- Name: contact_type contacttypeid; Type: DEFAULT; Schema: person; Owner: postgres
--

ALTER TABLE ONLY person.contact_type ALTER COLUMN contacttypeid SET DEFAULT nextval('person.contacttype_contacttypeid_seq'::regclass);


--
-- Name: email_address emailaddressid; Type: DEFAULT; Schema: person; Owner: postgres
--

ALTER TABLE ONLY person.email_address ALTER COLUMN emailaddressid SET DEFAULT nextval('person.emailaddress_emailaddressid_seq'::regclass);


--
-- Name: phone_number_type phonenumbertypeid; Type: DEFAULT; Schema: person; Owner: postgres
--

ALTER TABLE ONLY person.phone_number_type ALTER COLUMN phonenumbertypeid SET DEFAULT nextval('person.phonenumbertype_phonenumbertypeid_seq'::regclass);


--
-- Name: state_province stateprovinceid; Type: DEFAULT; Schema: person; Owner: postgres
--

ALTER TABLE ONLY person.state_province ALTER COLUMN stateprovinceid SET DEFAULT nextval('person.stateprovince_stateprovinceid_seq'::regclass);


--
-- Name: bill_of_materials billofmaterialsid; Type: DEFAULT; Schema: production; Owner: postgres
--

ALTER TABLE ONLY production.bill_of_materials ALTER COLUMN billofmaterialsid SET DEFAULT nextval('production.billofmaterials_billofmaterialsid_seq'::regclass);
