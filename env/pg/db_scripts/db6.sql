...
ALTER TABLE db.pl_addresses OWNER TO postgres;
...
ALTER SEQUENCE db.pl_address_addressid_seq OWNED BY db.pl_addresses.address_id;



CREATE TABLE db.pl_address_typo (
...
ALTER TABLE db.pl_address_typo OWNER TO postgres;
...
ALTER SEQUENCE db.pl_addresstype_addresstypeid_seq OWNED BY db.pl_address_typo.address_type_id;



CREATE TABLE db.pl_aplicant_for_job (
...
ALTER TABLE db.pl_aplicant_for_job OWNER TO postgres;
...
CREATE TABLE db.pl_bought_details (
...
ALTER TABLE db.pl_bought_details OWNER TO postgres;
...
CREATE TABLE db.pl_business_entity_contakt (
    business_entity_id integer NOT NULL,
...
ALTER TABLE db.pl_business_entity_contakt OWNER TO postgres;
...
ALTER TABLE db.pl_castomer OWNER TO postgres;
...
CREATE TABLE db.pl_country_currancy (
...
ALTER TABLE db.pl_country_currancy OWNER TO postgres;
...
CREATE TABLE db.pl_currancy_exchang_rate (
...
ALTER TABLE db.pl_currancy_exchang_rate OWNER TO postgres;
...
ALTER SEQUENCE db.pl_currencyrate_currencyrateid_seq OWNED BY db.pl_currancy_exchang_rate.currency_exchange_rate_id;
...
ALTER SEQUENCE db.pl_customer_customerid_seq OWNED BY db.pl_castomer.customer_id;
...
ALTER TABLE db.pl_diccount OWNER TO postgres;
...
ALTER SEQUENCE db.pl_illustration_illustrationid_seq OWNED BY db.pl_illustration.illustretion_id;
...
ALTER SEQUENCE db.pl_jobcandidate_jobcandidateid_seq OWNED BY db.pl_aplicant_for_job.applicant_for_job_id;
...
ALTER TABLE db.pl_persons OWNER TO postgres;


CREATE TABLE db.pl_persons_phone (
    business_entity_id integer NOT NULL,
...
ALTER TABLE db.pl_persons_phone OWNER TO postgres;
...
CREATE TABLE db.pl_product_dealers (
    product_id integer NOT NULL,
    business_entity_id integer NOT NULL,
...
ALTER TABLE db.pl_product_dealers OWNER TO postgres;
...
CREATE TABLE db.pl_product_diccount (
...
ALTER TABLE db.pl_product_diccount OWNER TO postgres;
...
ALTER SEQUENCE db.pl_productcategory_productcategoryid_seq OWNED BY db.pl_product_section.product_catagory_id;
...
ALTER SEQUENCE db.pl_productdescription_productdescriptionid_seq OWNED BY db.pl_product_description.product_descreption_id;
...
ALTER SEQUENCE db.pl_productsubcategory_productsubcategoryid_seq OWNED BY db.pl_product_subcategory.product_subcatagory_id;
...
ALTER SEQUENCE db.pl_purchaseorderdetail_purchaseorderdetailid_seq OWNED BY db.pl_bought_details.buy_details_id;
...
ALTER TABLE db.pl_shifts OWNER TO postgres;


CREATE TABLE db.pl_shipmet_method (
...
ALTER TABLE db.pl_shipmet_method OWNER TO postgres;
...
ALTER SEQUENCE db.pl_shipmethod_shipmethodid_seq OWNED BY db.pl_shipmet_method.shipmet_method_id;
...
ALTER SEQUENCE db.pl_specialoffer_specialofferid_seq OWNED BY db.pl_diccount.discount_id;
...
ALTER TABLE ONLY db.pl_address_typo ALTER COLUMN address_type_id SET DEFAULT nextval('db.pl_addresstype_addresstypeid_seq'::regclass);



ALTER TABLE ONLY db.pl_addresses ALTER COLUMN address_id SET DEFAULT nextval('db.pl_address_addressid_seq'::regclass);



ALTER TABLE ONLY db.pl_aplicant_for_job ALTER COLUMN applicant_for_job_id SET DEFAULT nextval('db.pl_jobcandidate_jobcandidateid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_bought_details ALTER COLUMN buy_details_id SET DEFAULT nextval('db.pl_purchaseorderdetail_purchaseorderdetailid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_castomer ALTER COLUMN customer_id SET DEFAULT nextval('db.pl_customer_customerid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_currancy_exchang_rate ALTER COLUMN currency_exchange_rate_id SET DEFAULT nextval('db.pl_currencyrate_currencyrateid_seq'::regclass);



ALTER TABLE ONLY db.pl_diccount ALTER COLUMN discount_id SET DEFAULT nextval('db.pl_specialoffer_specialofferid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_illustration ALTER COLUMN illustretion_id SET DEFAULT nextval('db.pl_illustration_illustrationid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_product_description ALTER COLUMN product_descreption_id SET DEFAULT nextval('db.pl_productdescription_productdescriptionid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_product_section ALTER COLUMN product_catagory_id SET DEFAULT nextval('db.pl_productcategory_productcategoryid_seq'::regclass);



ALTER TABLE ONLY db.pl_product_subcategory ALTER COLUMN product_subcatagory_id SET DEFAULT nextval('db.pl_productsubcategory_productsubcategoryid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_shipmet_method ALTER COLUMN shipmet_method_id SET DEFAULT nextval('db.pl_shipmethod_shipmethodid_seq'::regclass);
...
ALTER TABLE ONLY db.pl_address_typo
    ADD CONSTRAINT "PK_AddressType_AddressTypeID" PRIMARY KEY (address_type_id);

ALTER TABLE db.pl_address_typo CLUSTER ON "PK_AddressType_AddressTypeID";



ALTER TABLE ONLY db.pl_addresses
    ADD CONSTRAINT "PK_Address_AddressID" PRIMARY KEY (address_id);

ALTER TABLE db.pl_addresses CLUSTER ON "PK_Address_AddressID";
...
ALTER TABLE ONLY db.pl_business_entity_contakt
...
ALTER TABLE db.pl_business_entity_contakt CLUSTER ON "PK_BusinessEntityContact_BusinessEntityID_PersonID_ContactTypeI";
...
ALTER TABLE ONLY db.pl_country_currancy
    ADD CONSTRAINT "PK_CountryRegionCurrency_CountryRegionCode_CurrencyCode" PRIMARY KEY (country_code, currancy_code);

ALTER TABLE db.pl_country_currancy CLUSTER ON "PK_CountryRegionCurrency_CountryRegionCode_CurrencyCode";
...
ALTER TABLE ONLY db.pl_currancy_exchang_rate
    ADD CONSTRAINT "PK_CurrencyRate_CurrencyRateID" PRIMARY KEY (currency_exchange_rate_id);

ALTER TABLE db.pl_currancy_exchang_rate CLUSTER ON "PK_CurrencyRate_CurrencyRateID";
...
ALTER TABLE ONLY db.pl_castomer
    ADD CONSTRAINT "PK_Customer_CustomerID" PRIMARY KEY (customer_id);

ALTER TABLE db.pl_castomer CLUSTER ON "PK_Customer_CustomerID";
...
ALTER TABLE ONLY db.pl_aplicant_for_job
    ADD CONSTRAINT "PK_JobCandidate_JobCandidateID" PRIMARY KEY (applicant_for_job_id);

ALTER TABLE db.pl_aplicant_for_job CLUSTER ON "PK_JobCandidate_JobCandidateID";
...
ALTER TABLE ONLY db.pl_persons
    ADD CONSTRAINT "PK_Person_BusinessEntityID" PRIMARY KEY (business_entity_id);

ALTER TABLE db.pl_persons CLUSTER ON "PK_Person_BusinessEntityID";
...
ALTER TABLE ONLY db.pl_product_dealers
    ADD CONSTRAINT "PK_ProductVendor_ProductID_BusinessEntityID" PRIMARY KEY (product_id, business_entity_id);

ALTER TABLE db.pl_product_dealers CLUSTER ON "PK_ProductVendor_ProductID_BusinessEntityID";
...
ALTER TABLE ONLY db.pl_shifts
    ADD CONSTRAINT "PK_Shift_ShiftID" PRIMARY KEY (shift_id);

ALTER TABLE db.pl_shifts CLUSTER ON "PK_Shift_ShiftID";



ALTER TABLE ONLY db.pl_shipmet_method
    ADD CONSTRAINT "PK_ShipMethod_ShipMethodID" PRIMARY KEY (shipmet_method_id);

ALTER TABLE db.pl_shipmet_method CLUSTER ON "PK_ShipMethod_ShipMethodID";
...
ALTER TABLE ONLY db.pl_product_diccount
    ADD CONSTRAINT "PK_SpecialOfferProduct_SpecialOfferID_ProductID" PRIMARY KEY (product_discount_id, product_id);

ALTER TABLE db.pl_product_diccount CLUSTER ON "PK_SpecialOfferProduct_SpecialOfferID_ProductID";



ALTER TABLE ONLY db.pl_diccount
    ADD CONSTRAINT "PK_SpecialOffer_SpecialOfferID" PRIMARY KEY (discount_id);

ALTER TABLE db.pl_diccount CLUSTER ON "PK_SpecialOffer_SpecialOfferID";
...
ALTER TABLE ONLY db.pl_materials_bills
    ADD CONSTRAINT "FK_BillOfMaterials_UnitMeasure_UnitMeasureCode" FOREIGN KEY (unit_measuare_code) REFERENCES db.pl_measure_unit(unit_measure_code);



ALTER TABLE ONLY db.pl_business_entity_address
    ADD CONSTRAINT "FK_BusinessEntityAddress_AddressType_AddressTypeID" FOREIGN KEY (address_type_id) REFERENCES db.pl_address_typo(address_type_id);



ALTER TABLE ONLY db.pl_business_entity_address
    ADD CONSTRAINT "FK_BusinessEntityAddress_Address_AddressID" FOREIGN KEY (address_id) REFERENCES db.pl_addresses(address_id);
...
ALTER TABLE ONLY db.pl_business_entity_contakt
    ADD CONSTRAINT "FK_BusinessEntityContact_ContactType_ContactTypeID" FOREIGN KEY (typo_contakt_id) REFERENCES db.pl_contact_type(contact_type_id);



ALTER TABLE ONLY db.pl_business_entity_contakt
    ADD CONSTRAINT "FK_BusinessEntityContact_Person_PersonID" FOREIGN KEY (person_id) REFERENCES db.pl_persons(business_entity_id);
...
ALTER TABLE ONLY db.pl_country_currancy
    ADD CONSTRAINT "FK_CountryRegionCurrency_Currency_CurrencyCode" FOREIGN KEY (currancy_code) REFERENCES db.pl_currency(currency_code);
...
ALTER TABLE ONLY db.pl_castomer
    ADD CONSTRAINT "FK_Customer_Person_PersonID" FOREIGN KEY (person_id) REFERENCES db.pl_persons(business_entity_id);
...
ALTER TABLE ONLY db.pl_email_address
    ADD CONSTRAINT "FK_EmailAddress_Person_BusinessEntityID" FOREIGN KEY (business_entity_id) REFERENCES db.pl_persons(business_entity_id);
...
ALTER TABLE ONLY db.pl_history_employee_department
    ADD CONSTRAINT "FK_EmployeeDepartmentHistory_Shift_ShiftID" FOREIGN KEY (shift_id) REFERENCES db.pl_shifts(shift_id);



ALTER TABLE ONLY db.pl_password
    ADD CONSTRAINT "FK_Password_Person_BusinessEntityID" FOREIGN KEY (business_entity_id) REFERENCES db.pl_persons(business_entity_id);
...
ALTER TABLE ONLY db.pl_payment_card_person
    ADD CONSTRAINT "FK_PersonCreditCard_Person_BusinessEntityID" FOREIGN KEY (business_entity_id) REFERENCES db.pl_persons(business_entity_id);



ALTER TABLE ONLY db.pl_persons_phone
    ADD CONSTRAINT "FK_PersonPhone_Person_BusinessEntityID" FOREIGN KEY (business_entity_id) REFERENCES db.pl_persons(business_entity_id);
...
ALTER TABLE ONLY db.pl_product_document
    ADD CONSTRAINT "FK_ProductDocument_Document_DocumentNode" FOREIGN KEY (documet_node) REFERENCES db.pl_document(document_node);
...
ALTER TABLE ONLY db.pl_product_model_illustration
    ADD CONSTRAINT "FK_ProductModelIllustration_Illustration_IllustrationID" FOREIGN KEY (illustration_id) REFERENCES db.pl_illustration(illustretion_id);
...
ALTER TABLE ONLY db.pl_product_model_product_description_culture
    ADD CONSTRAINT "FK_ProductModelProductDescriptionCulture_ProductDescription_Pro" FOREIGN KEY (product_description_id) REFERENCES db.pl_product_description(product_descreption_id);
...
ALTER TABLE ONLY db.pl_product_subcategory
    ADD CONSTRAINT "FK_ProductSubcategory_ProductCategory_ProductCategoryID" FOREIGN KEY (product_catagory_id) REFERENCES db.pl_product_section(product_catagory_id);
...
ALTER TABLE ONLY db.pl_product_dealers
    ADD CONSTRAINT "FK_ProductVendor_UnitMeasure_UnitMeasureCode" FOREIGN KEY (unit_meazure_code) REFERENCES db.pl_measure_unit(unit_measure_code);
...
ALTER TABLE ONLY db.pl_product
    ADD CONSTRAINT "FK_Product_ProductSubcategory_ProductSubcategoryID" FOREIGN KEY (product_subcategory_id) REFERENCES db.pl_product_subcategory(product_subcatagory_id);
...
ALTER TABLE ONLY db.pl_bought_details
    ADD CONSTRAINT "FK_PurchaseOrderDetail_Product_ProductID" FOREIGN KEY (product_id) REFERENCES db.pl_product(product_id);



ALTER TABLE ONLY db.pl_sales_order_detail
    ADD CONSTRAINT "FK_SalesOrderDetail_SpecialOfferProduct_SpecialOfferIDProductID" FOREIGN KEY (discount_id, product_id) REFERENCES db.pl_product_diccount(product_discount_id, product_id);
...
ALTER TABLE ONLY db.pl_product_diccount
    ADD CONSTRAINT "FK_SpecialOfferProduct_SpecialOffer_SpecialOfferID" FOREIGN KEY (product_discount_id) REFERENCES db.pl_diccount(discount_id);
