...
public class Const {
    ...
    public static class SettingsXml {
        ...
        public static final String WORD_MATCHERS = "word-matchers";
        public static final String EXTRA_MATCHING = "extra-matching";
        public static final String MATCHING_COMPONENT = "component";
